...
- [x] 4ffa78ef (2026-02-16T07:35:17.260908+00:00) -- Added EXPERIMENT_WORKER_PROMPT_TEMPLATE in worker.py with template selection based on unit.experimen (files: src/mission_control/worker.py, src/mission_control/continuous_controller.py, tests/test_experiment_runtime.py)
